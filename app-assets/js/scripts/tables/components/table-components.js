/*=========================================================================================
	...
	----------------------------------------------------------------------------------------
	Item Name: Admin Theme - Clean Bootstrap 4 Dashboard HTML Template
	Version: 1.0
	Author:    
	Author URL: h  
==========================================================================================*/
  ...
  'use strict';
    ...
    function formatState (state) {
      if (!state.id) { return state.text; }
        ...
        var $state = $(
          '<span><img src="app-assetslags/' + state.element.value.toLowerCase() + '.png" class="img-flag" /> ' + state.text + '</span>'
        );
        return $state;
      }
    }
